...
return(
 ...
 {
            dataItems.map(eachItem=>{
                const {thumbnail, price, title, rating ,brand} = eachItem
                return(
                  <div  style={{padding:"15px",margin:"15px",width:"15%"}}>
                      <img   style={{borderRadius:"8px"}} src={thumbnail} alt="" height={180} width={150}/>
